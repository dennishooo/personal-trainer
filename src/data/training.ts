...
const ALL_EXERCISES: Exercise[] = [
  {
      ...
      },
      {
        ...
        restSec: 75,
        loadNote: 'band tension',
        position: 'Push-up position, band across the upper back, ends pinned under each hand',
        cue: 'The band pulls back hardest at lockout — fight for the last inch.',
        form: [
          'Loop the band across your upper back and trap each end under a palm.',
          'Set up in a push-up position, body in one line from head to heels.',
          'Lower until your chest nearly touches the floor, elbows about 45° from the torso.',
          'Press up against the rising band tension to a full lockout.',
        ],
        upgrade: 'Makes push-ups progressive again once bodyweight alone is easy — the tension rises exactly where a plain push-up gets easiest. Use it as a finisher after the dumbbell presses.',
      ...
      },
      {
        ...
        restSec: 60,
        loadNote: 'band tension',
        position: 'Standing on the middle of the band, a handle in each hand',
        cue: 'Tension peaks at the top — pause a second at the full squeeze.',
        form: [
          'Stand on the band with both feet; step wider for more resistance.',
          'Curl with the elbows pinned to your sides.',
          'Hold the top position for one second before lowering slowly.',
        ],
        upgrade: 'The opposite loading profile to the incline curl: the dumbbell hits the stretched position, the band hits the squeeze at the top. Together they cover the whole curve.',
        formUrl: 'https://exrx.net/WeightExercises/Biceps/CBCurl',
        formUrlExact: false,
      },
      {
        id: 'db-skullcrusher',
      ...
      },
      {
        ...
        restSec: 60,
        loadNote: 'band tension',
        position: 'Standing, band anchored high in front of you',
        cue: 'Elbows pinned to your sides — only the forearms move.',
        form: [
          'Anchor the band high — the same door anchor as the lat pulldown works.',
          'Grip an end in each hand, elbows bent past 90° at the start.',
          'Push down until the arms are fully straight, squeezing at lockout.',
          'Return under control without letting the elbows drift forward.',
        ],
        upgrade: 'The mirror of the skullcrusher: the dumbbell loads the triceps stretched, the band peaks at lockout where the skullcrusher goes slack.',
        formUrl: 'https://exrx.net/WeightExercises/Triceps/CBPushdown',
        formUrlExact: false,
      },
      {
        id: 'band-pallof',
        ...
        restSec: 60,
        loadNote: 'band tension',
        position: 'Standing side-on to the anchor point, hands at your sternum',
        cue: 'Nothing moves except the arms — resisting the twist is the exercise.',
        form: [
          'Anchor the band at chest height and stand side-on, far enough out for real tension.',
          'Hold the band with both hands against your sternum.',
          'Press the hands straight out and hold two seconds — the band tries to twist you toward the anchor.',
          'Return to the sternum. Finish all reps facing one way before switching.',
        ],
        upgrade: 'Fills the one core pattern the plank and leg raise miss: anti-rotation, the thing your trunk actually does under a heavy single-arm row or single-leg RDL.',
        formUrl: 'https://exrx.net/WeightExercises/Obliques/CBTwist',
        formUrlExact: false,
      },
]
