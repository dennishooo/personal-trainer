...
const fixture: NutritionGroup[] = [
  {
    ...
    icon: 'steak',
    items: [
      { name: 'Beef sirloin', icon: 'steak', cut: 'Loin', leanness: 'lean', kcal: 130, proteinG: 22.5, carbG: 0, fatG: 4.1, portion: '150 g' },
      { name: 'Beef short rib', icon: 'steak', cut: 'Rib', leanness: 'fatty', kcal: 380, proteinG: 15.1, carbG: 0, fatG: 35.7, portion: '120 g' },
      { name: 'Beef flank', icon: 'steak', cut: 'Flank', leanness: 'medium', kcal: 192, proteinG: 21.2, carbG: 0, fatG: 11.6, portion: '150 g', inPlan: true },
    ],
  },
  {
    name: 'Fats',
